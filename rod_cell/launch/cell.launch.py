    ...
    return LaunchDescription([
        ...
        Node(package='ros_gz_sim', executable='create',
             arguments=['-name', 'fence_north_gap1_top', '-string',
                        make_static_sdf('fence_north_gap1_top', fence_ng1_mesh, -0.750, 1.10, 1.80)]),
        Node(package='ros_gz_sim', executable='create',
        ...
        Node(package='ros_gz_sim', executable='create',
             arguments=['-name', 'fence_north_gap2_top', '-string',
                        make_static_sdf('fence_north_gap2_top', fence_ng2_mesh, 0.000, 1.10, 1.80)]),
        Node(package='ros_gz_sim', executable='create',
        ...
        Node(package='ros_gz_sim', executable='create',
             arguments=['-name', 'fence_south_gap_top', '-string',
                        make_static_sdf('fence_south_gap_top', fence_sg_mesh, 0.000, -0.90, 1.80)]),
        Node(package='ros_gz_sim', executable='create',
